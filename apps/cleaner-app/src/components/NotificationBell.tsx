...
export function NotificationBell() {
  ...
  return (
    <div className="relative">
      <button
        onClick={togglePanel}
        className="relative p-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-navy-light/50 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 z-50 w-[340px] sm:w-[380px] bg-white dark:bg-navy-dark border border-slate-200 dark:border-slate-800 rounded-[24px] shadow-xl shadow-black/5 overflow-hidden"
            >
